      ...
      <div class="row mt-4">
          ...
          <div class="col-md-8">
            ...
            <div class="form-group row">
              <img src="https://raw.githubusercontent.com/dheeru5555/captcha_reactjs/main/src/2.png" className="mt-3 mb-3" height="90"/> <span class="font-weight-bold ml-3"  style={{ marginTop:"50px"}} >Mariah Benchos</span>
            </div>
            <div class="form-group row">
